...
import com.fsck.k9droidtn.Account.SortType;
import com.fsck.k9droidtn.activity.MessageCompose;
...
import com.fsck.k9droidtn.mail.internet.BinaryTempFileBody;
import com.fsck.k9droidtn.provider.UnreadWidgetProvider;
import com.fsck.k9droidtn.service.BootReceiver;
import com.fsck.k9droidtn.service.MailService;
import com.fsck.k9droidtn.service.ShutdownReceiver;
import com.fsck.k9droidtn.service.StorageGoneReceiver;
...
public class K9 extends Application {
    ...
    public static class Intents {
        ...
        public static class EmailReceived {
            public static final String ACTION_EMAIL_RECEIVED    = "com.fsck.k9droidtn.intent.action.EMAIL_RECEIVED";
            public static final String ACTION_EMAIL_DELETED     = "com.fsck.k9droidtn.intent.action.EMAIL_DELETED";
            public static final String ACTION_REFRESH_OBSERVER  = "com.fsck.k9droidtn.intent.action.REFRESH_OBSERVER";
            public static final String EXTRA_ACCOUNT            = "com.fsck.k9droidtn.intent.extra.ACCOUNT";
            public static final String EXTRA_FOLDER             = "com.fsck.k9droidtn.intent.extra.FOLDER";
            public static final String EXTRA_SENT_DATE          = "com.fsck.k9droidtn.intent.extra.SENT_DATE";
            public static final String EXTRA_FROM               = "com.fsck.k9droidtn.intent.extra.FROM";
            public static final String EXTRA_TO                 = "com.fsck.k9droidtn.intent.extra.TO";
            public static final String EXTRA_CC                 = "com.fsck.k9droidtn.intent.extra.CC";
            public static final String EXTRA_BCC                = "com.fsck.k9droidtn.intent.extra.BCC";
            public static final String EXTRA_SUBJECT            = "com.fsck.k9droidtn.intent.extra.SUBJECT";
            public static final String EXTRA_FROM_SELF          = "com.fsck.k9droidtn.intent.extra.FROM_SELF";
        }

        public static class Share {
            /*
             * We don't want to use EmailReceived.EXTRA_FROM ("com.fsck.k9droidtn.intent.extra.FROM")
             * because of different semantics (String array vs. string with comma separated
             * email addresses)
             */
            public static final String EXTRA_FROM               = "com.fsck.k9droidtn.intent.extra.SENDER";
        }
    }
