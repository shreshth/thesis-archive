...
import com.fsck.k9droidtn.AccountStats;
import com.fsck.k9droidtn.K9;
import com.fsck.k9droidtn.K9.Intents;
import com.fsck.k9droidtn.NotificationSetting;
import com.fsck.k9droidtn.Preferences;
import com.fsck.k9droidtn.R;
import com.fsck.k9droidtn.SearchSpecification;
import com.fsck.k9droidtn.activity.FolderList;
import com.fsck.k9droidtn.activity.MessageList;
...
import com.fsck.k9droidtn.mail.store.LocalStore.LocalMessage;
import com.fsck.k9droidtn.mail.store.LocalStore.PendingCommand;
import com.fsck.k9droidtn.mail.store.UnavailableAccountException;
import com.fsck.k9droidtn.mail.store.UnavailableStorageException;
...
public class MessagingController implements Runnable {
    ...
    private static final String PENDING_COMMAND_MOVE_OR_COPY = "com.fsck.k9droidtn.MessagingController.moveOrCopy";
    private static final String PENDING_COMMAND_MOVE_OR_COPY_BULK = "com.fsck.k9droidtn.MessagingController.moveOrCopyBulk";
    private static final String PENDING_COMMAND_MOVE_OR_COPY_BULK_NEW = "com.fsck.k9droidtn.MessagingController.moveOrCopyBulkNew";
    private static final String PENDING_COMMAND_EMPTY_TRASH = "com.fsck.k9droidtn.MessagingController.emptyTrash";
    private static final String PENDING_COMMAND_SET_FLAG_BULK = "com.fsck.k9droidtn.MessagingController.setFlagBulk";
    private static final String PENDING_COMMAND_SET_FLAG = "com.fsck.k9droidtn.MessagingController.setFlag";
    private static final String PENDING_COMMAND_APPEND = "com.fsck.k9droidtn.MessagingController.append";
    private static final String PENDING_COMMAND_MARK_ALL_AS_READ = "com.fsck.k9droidtn.MessagingController.markAllAsRead";
    private static final String PENDING_COMMAND_EXPUNGE = "com.fsck.k9droidtn.MessagingController.expunge";
...
//    	return;
    	Log.d("DEBUG", "background sync commencing");
        IntentFilter filter = new IntentFilter();
        filter.addAction("com.iw.callback");
        final BroadcastReceiver receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                putBackground("synchronizeMailbox", listener, new Runnable() {
                    @Override
                    public void run() {
                    	Log.d("DEBUG", "Callback received. sync commencing");
                        synchronizeMailboxSynchronous(account, folder, listener, providedRemoteFolder);
                    }
                });
            }
        ...
        Intent intent = new Intent("com.iw.predrequest");
