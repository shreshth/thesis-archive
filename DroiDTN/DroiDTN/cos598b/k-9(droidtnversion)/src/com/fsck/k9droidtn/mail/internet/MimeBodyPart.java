...
package com.fsck.k9droidtn.mail.internet;
...
public class MimeBodyPart extends BodyPart {
    ...
    public void setBody(Body body) throws MessagingException {
        this.mBody = body;
        if (body instanceof com.fsck.k9droidtn.mail.Multipart) {
            com.fsck.k9droidtn.mail.Multipart multipart = ((com.fsck.k9droidtn.mail.Multipart)body);
