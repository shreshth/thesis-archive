...
import com.fsck.k9droidtn.remotecontrol.K9RemoteControl;
import com.fsck.k9droidtn.Preferences;
import com.fsck.k9droidtn.R;
import com.fsck.k9droidtn.Account.FolderMode;
import com.fsck.k9droidtn.K9.BACKGROUND_OPS;

import static com.fsck.k9droidtn.remotecontrol.K9RemoteControl.*;
...
public class RemoteControlService extends CoreService {
    private final static String RESCHEDULE_ACTION = "com.fsck.k9droidtn.service.RemoteControlService.RESCHEDULE_ACTION";
    private final static String PUSH_RESTART_ACTION = "com.fsck.k9droidtn.service.RemoteControlService.PUSH_RESTART_ACTION";

    private final static String SET_ACTION = "com.fsck.k9droidtn.service.RemoteControlService.SET_ACTION";
            ...
            execute(getApplication(), new Runnable() {
                public void run() {
                    try {
                        ...
                        if (needsReschedule) {
                            Intent i = new Intent();
                            i.setClassName(getApplication().getPackageName(), "com.fsck.k9droidtn.service.RemoteControlService");
