...
public class Address extends TestCase {
    ...
    public void testParseWithMissingEmail() {
        com.fsck.k9droidtn.mail.Address[] addresses =  com.fsck.k9droidtn.mail.Address.parse("NAME ONLY");
    ...
    public void testPraseWithValidEmail() {
        com.fsck.k9droidtn.mail.Address[] addresses =  com.fsck.k9droidtn.mail.Address.parse("Max Mustermann <maxmuster@mann.com>");
        assertEquals(1, addresses.length);
    ...
    public void testPraseWithValidEmailMulti() {
        com.fsck.k9droidtn.mail.Address[] addresses =  com.fsck.k9droidtn.mail.Address.parse("lorem@ipsum.us,mark@twain.com");
