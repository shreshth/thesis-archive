...
public class AppDatabaseHelperSave extends SQLiteOpenHelper {
    ...
    public AppDatabaseHelperSave(Context context) {
    ...
    private void addPoints(List<AppDataPoint> points) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public synchronized static int getNumRows(Context context) {
        AppDatabaseHelperSave db = new AppDatabaseHelperSave(context);
